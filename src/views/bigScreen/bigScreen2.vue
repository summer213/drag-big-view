                ...
                <div class="l-1">
                    <dv-border-box-7 :color="['#162E79','#008ACD']" class="border">
                        ...
                        <div class="droppable-box drop1">
                            <component :is="comForm[1].componentType" :chartOpt="comForm[1].chartOpt">
                            </component>
                        </div>
                    </dv-border-box-7>
                </div>
                <div class="l-2">
                    <dv-border-box-7 :color="['#162E79','#008ACD']" class="border">
                        ...
                        <div class="droppable-box drop2">
                            <component :is="comForm[2].componentType" :chartOpt="comForm[2].chartOpt">
                            </component>
                        </div>
                    </dv-border-box-7>
                </div>
                <div class="l-3">
                    <dv-border-box-7 :color="['#162E79','#008ACD']" class="border">
                        ...
                        <div class="droppable-box drop3">
                            <component :is="comForm[3].componentType" :chartOpt="comForm[3].chartOpt">
                            </component>
                        </div>
                    </dv-border-box-7>
                </div>
                    ...
                    <dv-border-box-7 :color="['#162E79','#008ACD']" class="c-1">
                        ...
                        <dv-border-box-7 :color="['#162E79','#008ACD']" v-show="mapCard" class="box-card drop9">
                            ...
                            <template>
                                ...
                                <div v-for="(item, index) in comForm[9].componentType" :key="index">
                                    <component :is="item">
                                    </component>
                                </div>
                            </template>
                    ...
                    <div class="c-2">
                        <dv-border-box-7 :color="['#162E79','#008ACD']" class="border">
                            ...
                            <div class="droppable-box drop4">
                                <component :is="comForm[4].componentType" :chartOpt="comForm[4].chartOpt">
                                </component>
                            </div>
                        </dv-border-box-7>
                    </div>
                    <div class="c-3">
                        <dv-border-box-7 :color="['#162E79','#008ACD']" class="border">
                            ...
                            <div class="droppable-box drop8">
                                <component :is="comForm[8].componentType" :chartOpt="comForm[8].chartOpt">
                                </component>
                            </div>
                        </dv-border-box-7>
                    </div>
                ...
                <div class="r-1">
                    <dv-border-box-7 :color="['#162E79','#008ACD']" class="border">
                        ...
                        <div class="droppable-box drop5">
                            <component :is="comForm[5].componentType" :chartOpt="comForm[5].chartOpt">
                            </component>
                        </div>
                    </dv-border-box-7>
                </div>
                ...
                <div class="r-2">
                    <dv-border-box-7 :color="['#162E79','#008ACD']" class="border">
                        ...
                        <div class="droppable-box drop6">
                            <component :is="comForm[6].componentType" :chartOpt="comForm[6].chartOpt">
                            </component>
                        </div> 
                    </dv-border-box-7>
                </div>
                <div class="r-3">
                    <dv-border-box-7 :color="['#162E79','#008ACD']" class="border">
                        ...
                        <div class="droppable-box drop7">
                            <component :is="comForm[7].componentType" :chartOpt="comForm[7].chartOpt">
                            </component>
                        </div>
                    </dv-border-box-7>
                </div>
